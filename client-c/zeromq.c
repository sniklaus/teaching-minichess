...
void zeromq_start() {
	...
	do {
		...
		if (strcmp(cJSON_GetObjectItem(objectIn, "strFunction")->valuestring, "ping") == 0) {
			...
			chess_moveNegamax(charOut, cJSON_GetObjectItem(objectIn, "intMaxdepth")->valueint, cJSON_GetObjectItem(objectIn, "intDuration")->valueint);
			...
			chess_moveAlphabeta(charOut, cJSON_GetObjectItem(objectIn, "intMaxdepth")->valueint, cJSON_GetObjectItem(objectIn, "intDuration")->valueint);
